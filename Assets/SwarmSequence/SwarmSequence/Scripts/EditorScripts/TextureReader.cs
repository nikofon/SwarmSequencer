...
namespace SwarmSequencer
{
    namespace EditorTools
    {
        public class TextureReader : EditorWindow
        {
            ...
            [MenuItem("Window/SwarmSequence/TextureReader (Legacy)")]
            ...
            {
                VisualTreeAsset origin = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/SwarmSequence/SwarmSequence/UIDocuments/UXML/TextureReader.uxml");
